...
function togglebtnDownload() {
	var btnDownload = document.getElementById("btnDownload");
	if (btnDownload.style.display === "none") {
		btnDownload.style.display = "block";
	}
}
document.getElementById("btnRM").addEventListener("click", togglebtnDownload);
function togglebtnDownload2() {
	var btnDownload2 = document.getElementById("btnDownload2");
	if (btnDownload2.style.display === "none") {
		btnDownload2.style.display = "block"; 
	}
}
document.getElementById("btnRM2").addEventListener("click", togglebtnDownload2);